...
<div>
    <div>
        ...
        <label class="form-check form-check-inline" style="white-space: nowrap">
            <g:radio class="form-check-input radioButton" name="operator" value="gt" checked="${evaluator == null || evaluator?.operator == 'gt' ? 'checked' : ''}"/>
    ...
    <div style="margin-top: 15px">
        <g:textField class="form-control form-control-sm" style="margin-left: 20px" name="numberValue" placeholder="Value" value="${evaluator?.value1}"/>
