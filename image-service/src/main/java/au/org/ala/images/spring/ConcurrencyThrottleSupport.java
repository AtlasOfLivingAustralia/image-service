 ...
 */
package au.org.ala.images.spring;
...
/**
 * This file has been modified from the original Spring source in order to support virtual threads in Spring 5.x Task Executors.
 *
 * Backport of later Spring 6 ConcurrencyThrottleSupport with support for onLimitReached and onAccessRejected..
 */
@SuppressWarnings("serial")
public abstract class ConcurrencyThrottleSupport extends org.springframework.util.ConcurrencyThrottleSupport implements Serializable {
