...
import au.org.ala.images.factory.JavaImageLibraryFactory

class JavaImageLibraryFactorySpec extends AbstractImageLibrarySpec {

    @Override
    ImageLibraryFactory getFactory() {
        return new JavaImageLibraryFactory()
    }
